...
> **Provenance copy.** This is the ORIGIN of the pack now living at
> `dream-weaver-visuals/docs/handoff/`. **That copy is the one agents read**; it carries the live
> banner explaining which of these rules still bind and which statements have gone historical. This
> one is kept only as the record of what was handed over on 2026-08-09.
